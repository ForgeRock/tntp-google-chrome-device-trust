...
public class GoogleChromeDeviceTrustPlugin extends AbstractNodeAmPlugin {
    protected static final String CURRENT_VERSION = "0.0.47";
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return new ImmutableMap.Builder<String, Iterable<? extends Class<? extends Node>>>()
            .put("1.0.0", asList(GoogleChromeDeviceTrust.class))
            .build();
    }
    ...
    public String getPluginVersion() {
        return GoogleChromeDeviceTrustPlugin.CURRENT_VERSION;
    }
    ...
    public void upgrade(String fromVersion) throws PluginException {
        ...
        try {
            pluginTools.upgradeAuthNode(GoogleChromeDeviceTrust.class);
        }
        catch (Exception e) {
